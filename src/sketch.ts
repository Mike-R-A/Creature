...
var world = new World();
world.Things = Helper.MakeNoOfFoodItems(50);
...
function draw() {
    ...
    world.Things.forEach(t => {
        ...
        t.move(Helper.RandomIntFromInterval(-1, 200) * xChange + Helper.RandomIntFromInterval(-1, 1), Helper.RandomIntFromInterval(-1, 200) * yChange + Helper.RandomIntFromInterval(-1, 1));
        t.draw();
    });
